...
class TestFeedOperation(unittest.TestCase):
    ...
    @unittest.mock.patch.object(FeedGenerator, 'subtitle')
    ...
    def test_update(self,
                    ...
                    mocked_upload,
                    mocked_fg_title, mocked_fg_subtitle, mocked_fg_link,
        ...
        mocked_fg_subtitle.assert_called_with(mocked_show.description)
        ...
        mocked_upload.assert_called_with(
            mocked_content, unique_id, feed_operation.FEED_FOLDER,
